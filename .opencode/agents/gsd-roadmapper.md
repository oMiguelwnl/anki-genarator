...
Reference full template: `C:/dev/script-dev/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/dev/script-dev/.opencode/get-shit-done/templates/state.md`.
