...
<required_reading>
@C:/dev/script-dev/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/dev/script-dev/.opencode
                  → checks C:/dev/script-dev/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/dev/script-dev/.opencode/get-shit-done
                  → writes to C:/dev/script-dev/.opencode/get-shit-done/hooks/
...
@C:/dev/script-dev/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/dev/script-dev/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/dev/script-dev/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/dev/script-dev/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/dev/script-dev/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
