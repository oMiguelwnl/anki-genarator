...
<reference>
@C:/dev/script-dev/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/dev/script-dev/.opencode/get-shit-done/references/user-profiling.md` to load:
