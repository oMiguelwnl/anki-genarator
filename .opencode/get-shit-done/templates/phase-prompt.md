...
<!-- For checkpoint task examples and patterns, see @C:/dev/script-dev/.opencode/get-shit-done/references/checkpoints.md -->
...
See `C:/dev/script-dev/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/dev/script-dev/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/dev/script-dev/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
