...
```bash
AUDITOR_MODEL=$(node "C:/dev/script-dev/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/dev/script-dev/.opencode/agents/gsd-eval-auditor.md for instructions.
