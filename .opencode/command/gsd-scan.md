...
<execution_context>
@C:/dev/script-dev/.opencode/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @C:/dev/script-dev/.opencode/get-shit-done/workflows/scan.md end-to-end.
</process>
