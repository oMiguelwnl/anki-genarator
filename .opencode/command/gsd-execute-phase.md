...
<execution_context>
@C:/dev/script-dev/.opencode/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @C:/dev/script-dev/.opencode/get-shit-done/workflows/execute-phase.md end-to-end.
