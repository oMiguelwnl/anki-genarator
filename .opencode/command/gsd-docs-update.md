...
<execution_context>
@C:/dev/script-dev/.opencode/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/dev/script-dev/.opencode/get-shit-done/workflows/docs-update.md end-to-end.
