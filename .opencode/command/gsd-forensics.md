...
<execution_context>
@C:/dev/script-dev/.opencode/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @C:/dev/script-dev/.opencode/get-shit-done/workflows/forensics.md end-to-end.
</process>
