...
<execution_context>
@C:/dev/script-dev/.opencode/get-shit-done/workflows/new-workspace.md
@C:/dev/script-dev/.opencode/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @C:/dev/script-dev/.opencode/get-shit-done/workflows/new-workspace.md end-to-end.
