...
<execution_context>
@C:/dev/script-dev/.opencode/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @C:/dev/script-dev/.opencode/get-shit-done/workflows/next.md end-to-end.
</process>
