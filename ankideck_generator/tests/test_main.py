...
def test_main_runtime_stage_budgets_and_log_retention_flow_into_run_config(
    ...
    config = {
        ...
        "runtime": {
            ...
            "full_level_size": 1000,
            "strict_quality": False,
            "ai_stage_call_limits": {"definition": 2, "lexical_review": 1},
            "preserve_evaluation_logs": True,
            "profiles": {
                "test": {
                    "ai_stage_call_limits": {"sentence": 3},
                }
            },
        },
        "cache": {
    ...
    assert exit_code == 0
    run = captured["run"]
    assert run.ai_stage_call_limits == {
        "definition": 2,
        "lexical_review": 1,
        "sentence": 3,
    }
    assert run.preserve_evaluation_logs is True
